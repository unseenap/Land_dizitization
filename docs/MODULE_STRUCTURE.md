...
The current folders contain ownership README files. Names below ending in .ts/.tsx or shown in the future tree are planned implementation locations, not implemented files.
