...
## Implemented Phase 2 through Phase 10 endpoints
...
| GET /feedback/datasets; POST /feedback/datasets | Scoped listing and approval-range dataset creation; creation requires feedback.manage |
| POST /feedback/datasets/{id}/review | Separate human approval/rejection with reason; requires feedback.manage |
| POST /feedback/datasets/{id}/export | Idempotent reviewed payload and SHA-256; requires feedback.export |
| GET /feedback/evaluations; POST /feedback/evaluations | Scoped listing and immutable model-version evaluation; requires feedback.read/manage |
